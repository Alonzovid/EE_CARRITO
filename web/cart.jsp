<%@page import="Controlador.BeanProducto"%>
<%@page import="Modelo.Producto"%>
<%@page import="Controlador.BeanArticulo"%>
				...
				<table class="table table-condensed">
					...
					<tbody>
						...
						<tr>
							...
							<td class="cart_total">
								<p class="cart_total_price">Q<%= Math.round(producto.getPrecio() * a.getCantidad() * 100.0 ) / 100.0 %></p>
							</td>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							<li>Cart Sub Total <span id="txt-subtotal">Q<%= Math.round(total*100.0)/100.0 %></span></li>
							<li>Eco Tax <span>Q0.0</span></li>
							<li>Shipping Cost <span>Free</span></li>
							<li>Total <span id="txt-total">Q<%= Math.round(total*100.0)/100.0 %></span></li>
						</ul>
